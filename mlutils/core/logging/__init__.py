        ...
        if Logger._instance is None:
            options = {
                "handlers": [
                    ...
                    {"sink": Path(log_dir) / 'performance.log', "enqueue": True, "format": '{message}', "filter": filter_record("SUCCESS")},
                    {"sink": Path(log_dir) / "events.log", "enqueue": True, "filter": filter_record("INFO", "WARNING")},
                ]
            }
